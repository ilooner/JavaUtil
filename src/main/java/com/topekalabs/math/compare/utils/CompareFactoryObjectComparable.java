 ...
 * @author Topeka Labs
 */
public class CompareFactoryObjectComparable<OBJECT extends Comparable> implements CompareFactoryObjectInterface<OBJECT>
{
    public CompareFactoryObjectComparable()
    {
        //Do nothing
    }
